...
//Delete row from patients where it matches patient name, diagnosis name and doctor name : 
$sql = "DELETE FROM Patients WHERE Patientname='$patientname' 
AND Diagnosis = '$diagnosisname'
